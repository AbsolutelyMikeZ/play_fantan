class PlayersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @player.save
        log_in @player
        format.html { redirect_to @player, notice: 'Account was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @player.update(player_params)
        format.html { redirect_to @player, notice: 'Account was successfully updated.' }
  ...
  def destroy
    @player.destroy
    respond_to do |format|
      format.html { redirect_to players_url, notice: 'Account was successfully destroyed.' }
